exports.seed = async function (knex) {
    ...
    await knex('project').insert([
        ...
        },
        {
            ...
            "description": "A single player card matching game using GIF images from the GIPHY API. This was a hackathon project completed in a two person team.",
